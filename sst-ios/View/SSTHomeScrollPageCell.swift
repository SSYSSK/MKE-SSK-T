//
//  SSTHomeScrollPageCell.swift
//  sst-ios
//
//  Created by MuChao Ke on 16/9/18.
//  Copyright © 2016年 SST. All rights reserved.
//

import UIKit

class SSTHomeScrollPageCell: SSTHomeScrollCell {
    ...
    override func initUI() {
        ...
        for index in -1 ... pageCount {
            ...
            let dataObj = objs?[dataInd] as? SSTSlide
            imageView.tag = dataInd
            imageView.setImage(fileUrl: validString(dataObj?.img), placeholder: kIcon_slide)
