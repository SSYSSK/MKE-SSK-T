...
class ToastUtil: NSObject {
    ...
    static func showToast(_ msg: String, duration: Double = 3.5) {
        ...
        let vcView: UIView! = getTopVC()?.view
        ...
        UIView.animate(withDuration: 0.3, delay: TimeInterval(expectedSize.height/10), options: UIViewAnimationOptions.allowAnimatedContent, animations: {
