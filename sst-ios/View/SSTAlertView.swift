...
class SSTAlertView: UIView {
    ...
    func addButton(_ title: String?, action:@escaping SSTAction) {
        ...
        button.setTitleColor(UIColorFromRGB(0x1062FF), for: UIControlState())
        button.setBackgroundImage(imageWithColor(UIColorFromRGB(0xE6E6E6)), for: UIControlState.highlighted)   // 230 230 230
        button.titleLabel?.font = UIFont.boldSystemFont(ofSize: 17)
        button.addTarget(self, action: #selector(SSTAlertView.buttonClicked(_:)), for: UIControlEvents.touchUpInside)
