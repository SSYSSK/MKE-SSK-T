...
//  sst-ios
//
//  Created by Zal Zhang on 9/7/17.
//  Copyright © 2017 ios. All rights reserved.
//

import UIKit

class SSTSearchVC: SSTBaseVC, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var searchBarBgViewHeightContraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        searchBarBgViewHeightContraint.constant = kScreenNavigationHeight
...
extension SSTSearchVC: SSTUIRefreshDelegate {
